...
import usePlaylistDetail from '../../graphql/requests/usePlaylistDetail'
...
import useAddTrackToPlaylist from "../../graphql/requests/useAddTrackToPlaylist"
import FourOrFour from "../../components/FourOrFour"
import HeaderTitle from "../../components/HeaderTitle"
import AlertDialog from "../../components/AlertDialog"
import CheckAuth from "../../components/CheckAuth"
// import { StyledTableCell } from "../../components/PlaylistTracksTable"
import useDeletePlaylistTrack from "../../graphql/requests/useDeletePlaylistTrack"
import useMyPlaylists from "../../graphql/requests/useMyPlaylists"
import useCreatePlaylist from "../../graphql/requests/useCreatePlaylist"
  ...
  return (
    <CheckAuth className="react-transition flip-in-x-reverse">
      ...
      {playlist ? (
        <>
          <HeaderTitle
            onClick={() => navigate(Routes.playlist.detailPage(playlist.hash))}
            icon={(
